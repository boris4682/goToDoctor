...
<template>
    <PagesTemplate class=" pb-[80px]">
      ...
      <div class=" w-[361px] h-[142px] border bg-gradient-to-r from-[#00B9C2] to-[#00585C] rounded-[14px] flex">
        <div class=" px-[33px] py-[18px]">
          <h4 class="font-semibold text-[20px] leading-6 text-white">Акции</h4>
          <p class="font-semibold text-[11px] leading-[13px] text-[#DADADA] w-[196px] mt-[7px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, s</p>
          <button class="w-[125px] h-[25px] rounded-[7px] bg-white mt-[14px]">Перейти</button>
        </div>
      ...
      <div class="flex justify-center items-center mt-[34px]">
        <div class=" w-[361px] h-[137px] rounded-[14px] border shadow-lg">
          <div class="flex flex-col px-[32px] py-[17px]">
            <p class="font-semibold text-[20px] leading-6 text-[#00B9C2]">Стоматолог хирург</p>
            <p class="font-normal text-[15px] leading-6 text-[#979797]">Сегодня в 18:00</p>
            <div class="flex justify-between mt-[40px]">
              <p class="font-semibold text-[12px] leading-[15px] text-[#828282]">Стоматологическая №1</p>
              <img :src="dalee"/>
            </div>
          </div>
        </div>
