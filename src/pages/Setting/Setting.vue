  ...
  <PagesTemplate>
    ...
    <div class="flex justify-center">
      <div class="pt-[20px] w-[354px] pb-[20px]">
        <p class="font-medium text-sm leading-4 text-[#A4A5A5]">
          Сменить пароль
        </p>
        <input
        ...
        />
        <p class="font-medium text-sm leading-4 text-[#A4A5A5] mt-[18px]">
        ...
        />
        <div
          class="w-full h-[55px] rounded-[30px] bg-[#00B9C2] flex items-center justify-center mt-[27px]"
        >
          <p
