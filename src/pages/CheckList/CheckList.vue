        ...
        <div class="flex flex-col gap-[22px] translate-y-[-10px]">
          ...
          <div class="mt-[26px] flex flex-col gap-[28px]">
            <RouterLink to="/treatment"
              ><div
                class="flex flex-col bg-[#F3F9FE] w-full h-[124px] rounded-[10px]"
              >
                <div class="my-[20px] mx-[20px]">
                  <h4
                    class="font-semibold text-xl leading-[24px] text-[#00B9C2]"
                  >
                    Стоматолог терапевт
                  </h4>
                  <p
                    class="mt-[8px] font-medium text-sm leading-[17px] text-[#2C3E4F]"
                  >
                    Адаптационный приём
                  </p>
                  <div class="flex justify-between mt-[12px]">
                    <p
                      class="font-medium text-xs leading-[14px] text-[#979797]"
                    >
